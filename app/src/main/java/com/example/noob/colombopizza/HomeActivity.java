...
import com.example.noob.colombopizza.Model.Category;
import com.example.noob.colombopizza.ViewHolder.MenuViewHolder;
...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FloatingActionButton bot = (FloatingActionButton) findViewById(R.id.bot);
        bot.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent cartIntent = new Intent(HomeActivity.this,BotActivity.class);
                startActivity(cartIntent);
    ...
    private void loadMenu() {
        ...
        adapter = new FirebaseRecyclerAdapter<Category, MenuViewHolder>(Category.class,R.layout.menu_item,MenuViewHolder.class,category) {
            ...
            protected void populateViewHolder(final MenuViewHolder viewHolder, Category model, int position) {
                ...
                Picasso.with(getBaseContext()).load(model.getImage()).into(viewHolder.imageView, new com.squareup.picasso.Callback() {
                    @Override
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        System.out.println("CategoryId ---------> "+adapter.getRef(position).getKey());
...
//            super.onBackPressed();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_menu) {
            ...
            Intent bot = new Intent(HomeActivity.this, BotActivity.class);
            startActivity(bot);
        }
